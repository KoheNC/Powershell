#https://thelazyadministrator.com/2018/03/19/get-friendly-license-name-for-all-users-in-office-365-using-powershell/#The_Script
...
Foreach ($User in $Users)
{
	...
	$Licenses = ((Get-MsolUser -All -UserPrincipalName $User.UserPrincipalName).Licenses).AccountSkuID
